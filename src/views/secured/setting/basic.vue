<template>
    <div>
        <div class="basic-panel" v-if="isUserLogin">
            ...
            <div class="pos-setting-list" :class="{'row-grid-5': !isMobileOnly}">
                <div class="pos-setting" :class="{'row-layout': !isMobileOnly}">
                    <div class="setting-list-group">
                        <div class="label-name">
                            {{ $t('pos_setting.menu_content.basic.entry_select_locale') }}
                        </div>
                        <div class="label-field-control">
                            <span v-if="isMobileOnly">{{ current_locale }}</span>
                ...
                <div class="pos-setting" :class="{'row-layout': !isMobileOnly}">
                    <div class="setting-list-group">
                        ...
                        <div class="label-field-control">
                            <span v-if="isMobileOnly">{{ current_currency }}</span>
